...
export const AuthLogin = () => {
    ...
    const handleAuthorizationEndpoint = () => {
        ...
        fetch(`https://expert-lab-oauth-project.onrender.com/api/oauth/authorize?response_type=${urlParams.response_type}&client_id=${urlParams.client_id}&state=${urlParams.state}&redirect_uri=${urlParams.redirect_uri}`, {
            credentials: 'include'
        })
        .then(response => response.json())
        .then(data => {
